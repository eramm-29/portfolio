        ...
        <div className="contact__container container grid">
          <div className="contact__data">
            ...
            <p className="contact__description">
              Feel free to get in touch with me. I am always open for discussing 
            ...
            <div className="info__item">
              ...
              <h4 className="info__desc">erampatel10@gmail.com</h4>
            </div>
            </div>
            ...
            <div className="info__item">
              ...
              <h4 className="info__desc">+91 9876543210</h4>
            </div>
            </div>
            </div>
